...
#PON EL CHOME DIRME EN UNA CARPETA ASI DEJA EL SERVICES ASI PORQUE CON EL PATH YA ESO ES VIEJO Y TE LO DICE AL EJECUTARLO
    ...
    driver.get('https://grupob.odoo.com/web#action=220&cids=10&menu_id=287&model=account.account&view_type=list')
    ...
    for i in range (4,300):
        ...
        print(cod.value, cuenta.value, tipo.value, perm.value, mon.value, comp.value)
        ...
        # select = Select(driver.find_element(By.XPATH,"/html/body/div[2]/div/div[2]/div[2]/div[1]/table/tbody/tr[1]/td[6]/div/div/input"))
        # select.select_by_visible_text(mon.value)
    ...
    #aqui haras el codicion del checkbox
        ...
        WebDriverWait(driver, 5000)\
             .until(EC.element_to_be_clickable((By.XPATH,
                                             "/html/body/div[2]/div/div[2]/div[2]/div[1]/table/tbody/tr[1]/td[6]/div/div/a".replace(' ', '.'))))\
        .send_keys(mon.value)
